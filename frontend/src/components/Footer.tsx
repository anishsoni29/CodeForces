    ...
    return (
        <div className="bg-transparent">
            <footer className="text-center bg-transparent py-12 border-b border-b-slate-100">
                ...
                <button className="bg-violet-500 rounded-lg p-4 shadow-lg hover:bg-blue-400" style={{ boxShadow: "8px 8px 16px #d1d5db, -8px -8px 16px #ffffff" }}>
                    <a href="https://www.google.com/" className="text-md text-white">Free trial for 30 days</a>
                </button>
            </footer>
            <div className="text-center">
                <a href="#" className="flex items-center justify-center mb-5 text-2xl font-semibold text-gray-900 dark:text-white">
                    <img src="/vslogo.png" alt="VS Logo" className="h-6 mr-3 sm:h-9" />
            ...
            <ul className="flex justify-center mt-5 space-x-5">
                <li>
                    <a href="#" className="text-gray-500 hover:text-gray-900 dark:hover:text-violet-500 dark:text-gray-400">
                ...
                <li>
                    <a href="#" className="text-gray-500 hover:text-gray-900 dark:hover:text-violet-500 dark:text-gray-400">
                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.482 4.073 4.073 0 01-1.86-.514v.052a4.106 4.106 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84"></path>
                        </svg>
                    </a>
                </li>
            </ul>

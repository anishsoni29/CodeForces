...
function LoaderSimple(props){
    ...
    return (
        <motion.div
            className="fixed bg-transparent h-screen top-0 left-0 w-full h-full flex justify-center items-center z-10"
            animate={controls}
        >
            <div className="p-4 rounded-md">
                <div className="flex justify-center">
                    <>
                        <motion.span
                            className="w-4 h-4 my-12 mx-1 bg-slate-700 rounded-full"
                            animate={{
                                y: [0, -20, 0],
